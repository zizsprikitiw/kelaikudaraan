					...
					<form class="form-horizontal" role="form" id="add_form" action="#" autocomplete="nope">
					  ...
					  <div class="modal-body">									  		 											
							...
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="nama">Jabatan Kegiatan</label>
							  <div class="col-lg-7">
							...
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="jenis_dokumen">Jenis Dokumen</label>
							  <div class="col-lg-7">
								<input type="text" class="form-control" placeholder="Jenis Dokumen" id="jenis_dokumen" name="jenis_dokumen">
							  </div>
							</div> 							
			...
			<div class="modal-dialog">
				<div class="modal-content">					
					  ...
					  <div class="modal-body">
					  		...
					  		<input type="hidden" value="" name="id_posisi" id="id_posisi"/>
							<!--begin: Datatable -->
