					...
					<form class="form-horizontal" role="form" id="add_form" action="#" autocomplete="nope">
					  ...
					  <div class="modal-body">									  		 											
							...
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="nama">Nama Pusat</label>
							  <div class="col-lg-7">
								<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Pusat">
							  </div>
							</div>
							
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="singkatan">Singkatan</label>
							  <div class="col-lg-7">
								<input type="text" class="form-control" id="singkatan" name="singkatan" placeholder="Nama Pusat">
							  </div>
							</div> 							
