					...
					<form class="form-horizontal" role="form" id="add_form" action="#" autocomplete="nope">
					  ...
					  <div class="modal-body">									  		 											
							...
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="nama">Struktural</label>
							  <div class="col-lg-6">
								<input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Struktural">
							  </div>
							</div> 
							
							<div class="form-group">
							  <label class="col-lg-3 control-label" for="nama">Singkatan</label>
							  <div class="col-lg-6">
			...
			<div class="modal-dialog">
				<div class="modal-content">					
					  ...
					  <div class="modal-body">
					  		...
					  		<input type="hidden" value="" name="id_struktural" id="id_struktural"/>
