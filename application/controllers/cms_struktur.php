...
class Cms_struktur extends CI_Controller {
	...
	{									
		$this->data['page_title'] = "Manajemen Struktur Leader dan Group Leader";
		...
		$this->data['add_javascript'] = array(
			base_url($this->config->item('assets')['assets_scripts'])."/cms_struktur.js",
		);
		
		$this->load->view('layout/header', array('config' => $this->_config, 'data' => $this->data));
		$this->load->view('cms/cms_struktur', $this->data);
	...
	public function data_list_group_leader()
	{
		...
		foreach ($list as $list_item) {
			...
			//add html for action
			$row[] = '<div class="btn-group btn-group-sm" role="group"><a class="btn btn-warning" href="javascript:void()" title="Edit" onclick="data_edit('."'".$list_item->id."','groups_leader'".')"><i class="la la-edit"></i></a>
				  <a class="btn btn-danger" href="javascript:void()" title="Hapus" onclick="data_delete('."'".$list_item->id."','".$list_item->nama."','groups_leader'".')"><i class="la la-times-circle"></i></a></div>';
	...
	public function data_list_leader()
	{
		...
		foreach ($list as $list_item) {
			...
			//add html for action
			$row[] = '<div class="btn-group btn-group-sm" role="group"><a class="btn btn-warning" href="javascript:void()" title="Edit" onclick="data_edit('."'".$list_item->id."','leader'".')"><i class="la la-edit"></i></a>
				  <a class="btn btn-danger" href="javascript:void()" title="Hapus" onclick="data_delete('."'".$list_item->id."','".$list_item->nama."','leader'".')"><i class="la la-times-circle"></i></a></div>';
