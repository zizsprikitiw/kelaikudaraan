...
class Cms_personil_kegiatan extends CI_Controller {
	...
	{									
		$this->data['page_title'] = "Manajemen Personil Kegiatan";
		...
		$this->data['add_javascript'] = array(
			base_url($this->config->item('assets')['assets_scripts'])."/cms_personil_kegiatan.js",
		);
		
		$this->load->view('layout/header', array('config' => $this->_config, 'data' => $this->data));
		$this->load->view('cms/cms_personil_kegiatan', $this->data);
	...
	public function data_list_personil()
	{
		...
		foreach ($list as $list_item) {
			...
			//add html for action
			$row[] = '<div class="btn-group btn-group-sm" role="group"><a class="btn btn-warning" href="javascript:void()" title="Edit" onclick="data_edit('."'".$list_item->id."'".')"><i class="la la-edit"></i></a>
				  <a class="btn btn-danger" href="javascript:void()" title="Hapus" onclick="data_delete('."'".$list_item->id."','".$list_item->nama_user."','".$posisi."'".')"><i class="la la-times-circle"></i></a></div>';
	...
	public function data_list_users()
	{
		...
		foreach ($list as $list_item) {
			...
			//add html for action
			$row[] = '<a class="btn btn-sm btn-primary" href="javascript:void()" title="Pilih" onclick="data_pick('."'".$list_item->id."','".$list_item->nama."'".')">Pilih</a>';
